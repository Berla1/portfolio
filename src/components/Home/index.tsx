...
const Home = () => {
  return (
    <section className="flex flex-col justify-center items-center pt-5 md:flex-row h-screen text-white md:justify-evenly md:items-center gap-10" id="home">
      ...
      <div className="flex items-center justify-center bg-gradient-to-t from-gray-600 rounded-3xl w-80 md:w-100">
